...
const routes: Routes = [
  ...
  { path: 'change-password', loadChildren: './pages/user/profile/change-password/change-password.module#ChangePasswordPageModule', canActivate: [AuthGuard]  },
  { path: 'order-history', loadChildren: './pages/user/profile/order-history/order-history.module#OrderHistoryPageModule', canActivate: [AuthGuard]  },
  { path: 'saved-address', loadChildren: './pages/user/profile/saved-address/saved-address.module#SavedAddressPageModule', canActivate: [AuthGuard]  },
  { path: 'add-address', loadChildren: './pages/user/profile/add-address/add-address.module#AddAddressPageModule', canActivate: [AuthGuard]  },
  { path: 'favorites', loadChildren: './pages/user/profile/favorites/favorites.module#FavoritesPageModule', canActivate: [AuthGuard] },
  ...
  { path: 'my-account', loadChildren: './pages/user/profile/my-account/my-account.module#MyAccountPageModule', canActivate: [AuthGuard]  },
